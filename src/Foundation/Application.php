...
use Laradic\Foundation\Traits\ApplicationPaths;
...
class Application extends Container implements ApplicationContract, HttpKernelInterface
{
     ...
     * @return void
     */
    public function __construct($name, $version, $appPath = null, $basePath = null)
    {
        $this->name    = $name;
